package com.isacc.datax.infra.dataobject;
...
public class DataxSyncDO {
    ...
    private Long jobId;
    @ApiModelProperty(value = "调度任务流ID,关联HDSP_DISP_WORKFLOW.WORKFLOW_ID,回写")
    private Long workflowId;
    @ApiModelProperty(value = "数据配置信息")
